...
# Init
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/etc/fstab.caymanslm:$(TARGET_COPY_OUT_RAMDISK)/fstab.caymanslm \
    $(LOCAL_PATH)/rootdir/etc/fstab.caymanslm:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.caymanslm
